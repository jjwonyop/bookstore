  ...
  return (
    <Layout activeMenu="news">
      ...
      <div className="container mx-auto px-4 md:py-16 py-8">
        <h2 className="text-3xl md:text-4xl font-bold mb-12 md:mb-20 text-center">아이와 글 소식</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 mb-16 max-w-5xl mx-auto">
          <div className="border border-gray-300 p-4 flex flex-col rounded-sm shadow-sm hover:shadow-md transition-shadow">
            ...
            <Link href="/news/new-books" className="text-center font-bold mt-auto py-2 border-t border-gray-300 mt-4 hover:text-gray-600">
              자세히 보기
            </Link>
          </div>
        </div>
